...
class Page(TenantAppHelper):
	...
	def processOfRequest(self, tenant):
		try:
			...
			self.render('error_client.html', self._design_type, template_vals)
		except BaseException, e:
			self.outputErrorLog(e)
			return

app = webapp2.WSGIApplication([('/a/([^/]*)/warning', Page)], debug=sateraito_inc.debug_mode, config=sateraito_func.wsgi_config)
