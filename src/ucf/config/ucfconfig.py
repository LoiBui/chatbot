...
#	# OpenID認証用クエリーキー
    ...
    #POSTMESSAGE
    SESSIONKEY_SCOND_POSTMESSAGE_LIST = 'f963b85eb6826f94b2137f3f6272cfbc'

    #TEMPLATE
    SESSIONKEY_SCOND_TEMPLATE_LIST = '66f6181bcb4cff4cd38fbc804a036db6'

    #POSTMESSAGE
    SESSIONKEY_SCOND_SEARCH_LIST = '0f544d682c3a664870f025f48c4b04b5'

    #FORM
    SESSIONKEY_SCOND_FORM_LIST = '3fcdb73d36d54f2cc22d0f68e6b6e182'

    #FORM DATA
    SESSIONKEY_SCOND_FORM_DATA_LIST = '207d9b2322665d9a282b2d723965d5f4'

    #STORE
    SESSIONKEY_SCOND_STORE_LIST = 'c2343f7aae283dc737b4b3596390071d'

    #STORE TEMPLATE
    SESSIONKEY_SCOND_STORE_TEMPLATE_LIST = '0f544d682c3a664870f025f48c4b04b9'
    ...
    SESSIONKEY_REGIST_USER_INFO = 'REGISTUSERSUCCESS'
    ...
    DELEGATE_FUNCTION_POSTMESSAGE_CONFIG = 'POSTMESSAGE'

    DELEGATE_FUNCTION_TEMPLATE_CONFIG = 'TEMPLATE'

    DELEGATE_FUNCTION_SEARCH_CONFIG = 'SEARCH'

    DELEGATE_FUNCTION_FORM_CONFIG = 'FORM'

    DELEGATE_FUNCTION_FORM_DATA_CONFIG = 'FORMDATA'

    DELEGATE_FUNCTION_CHAT_BOT_CONFIG = 'CHATBOT'

    DELEGATE_FUNCTION_STORE_CONFIG = 'STORE'

    DELEGATE_FUNCTION_EMAILMAGAZINE_CONFIG = 'EMAILMAGAZINE'

    DELEGATE_FUNCTION_FORM_RESULT_CONFIG = 'FORM_RESULT'

    DELEGATE_FUNCTION_STORE_RESULT_CONFIG = 'STORE_RESULT'

    DELEGATE_FUNCTION_CATEGORYMASTER_CONFIG = 'CATEGORYMASTER'

    DELEGATE_FUNCTION_FAQMASTER_CONFIG = 'FAQMASTER'

    DELEGATE_FUNCTION_DICTIONARY_CONFIG = 'DICTIONARY'
    ...
    OPERATION_TYPE_MODIFY_LINEWORKS_CONFIG = 'modify_lineworks_config'
    OPERATION_TYPE_MODIFY_MORE_CONFIG = 'modify_more_config'
    OPERATION_TYPE_MODIFY_DIRECTCLOUDBOX_CONFIG = 'modify_directcloudbox_config'
    ...
    SCREEN_POSTMESSAGE = 'postmessage'
    ...
    SCREEN_FAQMASTER = 'faqmaster'
    SCREEN_CATEGORYMASTER = 'categorymaster'

    # TOKEN KEY COMMON AJAX
    CSRF_GENERAL_TOKEN_KEY = 'GENERAL'
